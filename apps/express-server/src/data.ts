...
export const ingredientPrices: Record<string, number | undefined> =
...
} satisfies Record<string, NutritionData>;

export const ingredientNutrition: Record<string, NutritionData | undefined> =
  ingredientNutritionData;

const ingredientInventoryData = {
...
export const ingredientInventory: Record<string, InventoryData | undefined> =
  ingredientInventoryData;
