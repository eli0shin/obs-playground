          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-green-700 dark:text-green-300">
                Create recipe form with Server Function
              </p>
            </Link>
            <Link
              to="/testing/forms/broken-create"
            ...
            >
              ...
              <p className="mt-2 text-sm text-orange-700 dark:text-orange-300">
                Server Function that always fails
              </p>
            </Link>
            <Link
              to="/testing/client/broken-api"
            ...
            <Link
              to="/testing/client/broken-mutation"
