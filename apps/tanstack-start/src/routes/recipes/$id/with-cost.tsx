...
import { getRecipeWithCost } from "../../../server-fns/recipes";

export const Route = createFileRoute("/recipes/$id/with-cost")({
  loader: ({ params }) => getRecipeWithCost({ data: params.id }),
  component: RecipeWithCostPage,
});

function RecipeWithCostPage() {
