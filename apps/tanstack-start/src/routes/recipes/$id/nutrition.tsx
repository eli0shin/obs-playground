...
import { getRecipeWithNutrition } from "../../../server-fns/recipes";

export const Route = createFileRoute("/recipes/$id/nutrition")({
  loader: ({ params }) => getRecipeWithNutrition({ data: params.id }),
  component: RecipeNutritionPage,
});

function RecipeNutritionPage() {
