...
export type AllRecipesForAggregationQuery = { recipes: Array<{ id: string, title: string, ingredients: Array<{ quantity: number, ingredient: { id: string, name: string, unit: string } }> }> };
